...
AirChord is an interactive AI-powered virtual guitar companion web application that lets singers and musicians perform songs using camera hand-tracking gestures. Each gesture maps dynamically to guitar chords, with pluggable humanized audio engines, strumming patterns, and interactive practice rooms.
...
# Validate, test, and build for production
npm run test
npm run typecheck
npm run build
```
